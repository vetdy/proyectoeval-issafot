...
class AsistenciaEvaluacionController extends Controller
{
    /**
    ...
    /**
     * @OA\Put(
     *     path="/api/asistencia_evaluacion/{id}",
     *     summary="Actualizar una asistencia",
     *     tags={"Asistencia Evaluacion"},
     *     @OA\Parameter(
     *         name="id",
     *         in="path",
     *         description="ID del asistencia evaluacion",
     *         required=true,
     *         @OA\Schema(
     *             type="integer"
     *         )
    ...
    public function update(Request $request, $id)
    {
        ...
        $asistencia = Asistencia_evaluacion::find($id);
        if ($asistencia) {
